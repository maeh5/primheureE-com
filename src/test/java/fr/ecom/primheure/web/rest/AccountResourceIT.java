...
import static fr.ecom.primheure.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import fr.ecom.primheure.IntegrationTest;
import fr.ecom.primheure.config.Constants;
import fr.ecom.primheure.domain.User;
import fr.ecom.primheure.repository.AuthorityRepository;
import fr.ecom.primheure.repository.UserRepository;
import fr.ecom.primheure.security.AuthoritiesConstants;
import fr.ecom.primheure.service.UserService;
import fr.ecom.primheure.service.dto.AdminUserDTO;
import fr.ecom.primheure.service.dto.PasswordChangeDTO;
import fr.ecom.primheure.web.rest.vm.KeyAndPasswordVM;
import fr.ecom.primheure.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterDuplicateLogin() throws Exception {
        // FIXME: Login is supposed to be unique, is this test useful?
        try {
            // First registration
    ...
    void testRegisterDuplicateEmail() throws Exception {
        // FIXME: Email is supposed to be unique, is this test useful?
        try {
            // First user
            ManagedUserVM firstUser = new ManagedUserVM();
