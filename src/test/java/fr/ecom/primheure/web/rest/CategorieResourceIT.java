...
import fr.ecom.primheure.repository.CategorieRepository;
...
class CategorieResourceIT {
    ...
    private static final TypeProduit DEFAULT_TYPE = TypeProduit.FRUIT;
    private static final TypeProduit UPDATED_TYPE = TypeProduit.LEGUME;
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().type(DEFAULT_TYPE);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().type(UPDATED_TYPE);
        return categorie;
    }
    ...
    void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getType()).isEqualTo(DEFAULT_TYPE);
    }
    ...
    void putNewCategorie() throws Exception {
        ...
        updatedCategorie.type(UPDATED_TYPE);
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getType()).isEqualTo(UPDATED_TYPE);
    }
    ...
    void partialUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.type(UPDATED_TYPE);
