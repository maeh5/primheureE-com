...
export class ProduitService {
  ...
  updateStock(id: number, quantite: number, numeroVer: number): Observable<EntityResponseType> {
    const jsonVal = { quantite: quantite.toString(), numeroVer: numeroVer.toString() };
    return this.http.put<IProduit>(`${this.resourceUrlStock}/${id}`, jsonVal, { observe: 'response' });
  }
