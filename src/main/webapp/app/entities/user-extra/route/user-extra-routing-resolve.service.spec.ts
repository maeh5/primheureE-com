...
describe('UserExtra routing resolve service', () => {
  ...
  let resultUserExtra: IUserExtra | undefined;
  ...
  describe('resolve', () => {
    it('should return IUserExtra returned by find', () => {
      ...
      expect(resultUserExtra).toEqual({ id: 123 });
    });

    it('should return new IUserExtra if id is not provided', () => {
      // GIVEN
      ...
      expect(resultUserExtra).toEqual(new UserExtra());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as UserExtra })));
      mockActivatedRouteSnapshot.params = { id: 123 };
