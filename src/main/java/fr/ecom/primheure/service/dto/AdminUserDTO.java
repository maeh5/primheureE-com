package fr.ecom.primheure.service.dto;
...
public class AdminUserDTO {
    ...
    private Set<Commande> histCommandes;

    private Set<Adresse> adresses;

    private Set<CarteBancaire> cartesBancaires;
    ...
    public void sethistCommandes(Set<Commande> histCommandes) {
    ...
    public void setCarteBancaire(Set<CarteBancaire> cartesBancaires) {
